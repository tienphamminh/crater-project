    ...
    <section id="hero-area" class="hero-area">
        ...
        <div class="slider-area">
            ...
            <div class="single-slider"
                 style="background-image: url('<?php echo _WEB_HOST_CLIENT_TEMPLATE; ?>/assets/images/slider/slider-image1.jpg')"
            >
                <div class="container">
                    <div class="row">
                        <div class="col-lg-7 col-md-6 col-12">
                            ...
                            <div class="slider-text">
                                <h1>
                                    Crater <span>Business</span> World That Possible
                                    anything<span>!</span>
                                </h1>
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                    Morbi laoreet urna ante, quis luctus nisi sodales sit amet.
                                    Aliquam a enim in massa molestie mollis Proin quis velit at
                                    nisl vulputate egestas non in arcu Proin a magna hendrerit,
                                    tincidunt neque sed.
                                </p>
                                <div class="button">
                                    <a href="portfolio-3-column.html" class="btn"
                                    >Our Portfolio</a>
                                    <a href="https://www.youtube.com/watch?v=FZQPhrdKjow"
                                       class="btn video video-popup mfp-fade"
                                    ><i class="fa fa-play"></i>Play Now</a>
                                </div>
                            </div>
                            <!--/ End Slider Text -->
                        </div>
                        <div class="col-lg-5 col-md-6 col-12">
                            ...
                            <div class="image-gallery">
                                <div class="single-image">
                                    <img src="<?php echo _WEB_HOST_CLIENT_TEMPLATE; ?>/assets/images/slider/gallery-image1.jpg"
                                         alt="#"/>
                                </div>
                                <div class="single-image two">
                                    <img src="<?php echo _WEB_HOST_CLIENT_TEMPLATE; ?>/assets/images/slider/gallery-image2.jpg"
                                         alt="#"/>
                                </div>
                            </div>
                            <!--/ End Image Gallery -->
            ...
            <!--/ End Single Slider -->
            <!-- Single Slider -->
            <div class="single-slider slider-right"
                 style="background-image: url('<?php echo _WEB_HOST_CLIENT_TEMPLATE; ?>/assets/images/slider/slider-image2.jpg')"
            >
                <div class="container">
                    <div class="row">
                        <div class="col-lg-5 col-md-6 col-12">
            ...
            <!--/ End Single Slider -->
            <!-- Single Slider -->
            <div class="single-slider slider-center"
                 style="background-image: url('<?php echo _WEB_HOST_CLIENT_TEMPLATE; ?>/assets/images/slider/slider-image1.jpg')"
            >
                <div class="container">
                    <div class="row">
                        <div class="col-lg-10 offset-lg-1 col-12">
                            ...
                            <div class="slider-text text-center">
                                <h1>
                                    Build your website with Crater Multipurpose
                                    <span>Business</span> Template.
                                </h1>
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                    Morbi laoreet urna ante, quis luctus nisi sodales sit amet.
